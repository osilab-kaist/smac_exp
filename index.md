...
![Def_infantry](/assets/imgs/def/defense_infantry.png){: width="350" }
![Def_armored](/assets/imgs/def/defense_armored.png){: width="350" }
![Def_outnumbered](/assets/imgs/def/defense_outnumbered.png){: width="350" }
...
![Off_near](/assets/imgs/off/offense_near.png){: width="350" }
![Off_distant](/assets/imgs/off/offense_distant.png){: width="350" }
![Off_complicated](/assets/imgs/off/offense_complicated.png){: width="350" }
...
![Off_hard](/assets/imgs/cha/offense_hard.png){: width="350" }
![Off_superhard](/assets/imgs/cha/offense_superhard.png){: width="350" }
...
![Def_infantry](/assets/results/def_infantry_sequential.png){: width="350" }
![Def_armored](/assets/results/def_armored_sequential.png){: width="350" }
![Def_outnumbered](/assets/results/def_outnumbered_sequential.png){: width="350" }

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • **<span style="font-family:Raleway; font-size:1.0em;"> Parallel Episodic Buffer </span>**  
![Def_infantry](/assets/results/def_infantry_parallel.png){: width="350" }
![Def_armored](/assets/results/def_armored_parallel.png){: width="350" }
![Def_outnumbered](/assets/results/def_outnumbered_parallel.png){: width="350" }
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •**<span style="font-family:Raleway; font-size:1.0em;"> Sequential Episodic Buffer </span>**  
![Off_near](/assets/results/off_near_sequential.png){: width="350" }
![Off_distant](/assets/results/off_distant_sequential.png){: width="350" }
![Off_complicated](/assets/results/off_complicated_sequential.png){: width="350" }

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •**<span style="font-family:Raleway; font-size:1.0em;"> Parallel Episodic Buffer </span>**  
![Off_near](/assets/results/off_near_parallel.png){: width="350" }
![Off_distant](/assets/results/off_distant_parallel.png){: width="350" }
![Off_complicated](/assets/results/off_complicated_parallel.png){: width="350" }
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •**<span style="font-family:Raleway; font-size:1.0em;"> Sequential Episodic Buffer </span>**  
![Off_hard](/assets/results/off_hard_sequential.png){: width="350" }
![Off_superhard](/assets/results/off_superhard_sequential.png){: width="350" }

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; •**<span style="font-family:Raleway; font-size:1.0em;"> Parallel Episodic Buffer </span>**  
![Off_hard](/assets/results/off_hard_parallel.png){: width="350" }
![Off_superhard](/assets/results/off_superhard_parallel.png){: width="350" }
